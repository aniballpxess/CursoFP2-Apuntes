...
public class NavigationActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toLiteButton = findViewById(R.id.buttonLite); // Asegúrate de que el ID en el XML sea correcto

        // Configurar el escucha de clics para los botones
        toApiButton.setOnClickListener(this);
        toLiteButton.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        ...
        } else if (view.getId() == R.id.buttonLite) {
            // Navegar a la actividad de SQLite
            intent = new Intent(this, SQLitePeliculasActivity.class);
            startActivity(intent);
        } else {
