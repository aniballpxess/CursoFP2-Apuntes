package edu.dam2.psp.eva2.ejercicios.hilos.paresimpares.thread;

import static edu.dam2.psp.utiles.Funciones.printErrorLine;

public class HiloParesT extends Thread
{
    private final int limiteInf;
    private final int limiteSup;
    private final int tiempoEspera;

    public HiloParesT(int limiteInf, int limiteSup, int tiempoEspera)
    {
