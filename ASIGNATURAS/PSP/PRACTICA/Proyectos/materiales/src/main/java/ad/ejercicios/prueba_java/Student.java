...
/**
 * La clase Student representa a un estudiante, que es una extensión de la clase Person.
 * Un estudiante tiene un nombre completo, edad, especialidad (major) y créditos acumulados.
 */
class Student extends Person
{
    ...
    /**
     * Constructor que inicializa un estudiante con nombre completo, edad, especialidad y créditos.
    ...
    /**
     * Constructor que inicializa un estudiante con nombre completo, edad y especialidad,
     * estableciendo los créditos acumulados en 0.
     * @param fullName el nombre completo del estudiante.
     * @param age la edad del estudiante.
     * @param major la especialidad o carrera del estudiante.
     */
